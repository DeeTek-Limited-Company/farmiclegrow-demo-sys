...
export default async function AgronomistFarmProfilesPage({ params }: PageProps) {
              ...
              <CardHeader className="bg-slate-50/50 border-b border-slate-100 p-8">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Button asChild variant="outline" className="rounded-2xl font-black">
                    <Link href={`${orgBase}/agronomist/farmers/${p.farmerId}`}>
        ...
        <Card className="border-0 shadow-xl shadow-slate-200/50 rounded-[2rem] overflow-hidden">
          ...
          <CardContent className="p-6">
            <Button asChild className="rounded-2xl font-black h-12">
              <Link href={`${orgBase}/agronomist/onboarding`}>Register Farmer</Link>
            </Button>
          </CardContent>
        </Card>
      )}
